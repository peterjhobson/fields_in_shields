...
Design wire patterns on an open cylinder inside a closed cylindrical magnetic shield to generate
a target field inside the open cylinder.
...
beta = 5e-15 * (1e-3 / 1.68e-8)  # weighting of the power optimization term
